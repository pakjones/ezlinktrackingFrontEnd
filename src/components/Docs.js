                ...
                <div className="row">
                    <div className="col-lg-4">
                        ...
                        <div className="list-group">
                            <a href="https://github.com/pakjones/ezlinktrackingFrontEnd" className="list-group-item list-group-item-action list-group-item-info">Front End - React</a>
                            <a href="https://github.com/pakjones/EZLinkTrackingBackEnd" className="list-group-item list-group-item-action list-group-item-secondary">Back End - Express/MongoDB</a>
                        </div>
                    </div>
